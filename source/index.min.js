...
},{"../physics/physics":7,"../utilities/utilities":10}],4:[function(require,module,exports){
"use strict";
...
},{"../fires/fire":3,"../ice/ice":5,"../physics/physics":7,"../player/player":8,"../utilities/constants":9,"../utilities/utilities":10,"../world/tiles":11}],5:[function(require,module,exports){
"use strict";
var utilities = require("../utilities/utilities");
var physics = require("../physics/physics");
var currentPosition = new Phaser.Point(0, 0);
...
},{"../physics/physics":7,"../utilities/utilities":10}],6:[function(require,module,exports){
"use strict";
...
function calculateNextForBody(body) {
    var targetCollisionBody = buildCollisionBody(body);
...
function canFallBody(target) {
    var body = buildCollisionBody(target);
    var canFall = true;
    body.tile.y += 1;
    physics.physicsBodies.forEach(function (target) {
        var targetBody = buildCollisionBody(target);
...
},{"../utilities/constants":9,"../utilities/utilities":10,"../world/tiles":11}],8:[function(require,module,exports){
"use strict";
var utilities = require("../utilities/utilities");
var constant = require("../utilities/constants");
var physics = require("../physics/physics");
...
},{"../physics/physics":7,"../utilities/constants":9,"../utilities/utilities":10}],9:[function(require,module,exports){
"use strict";
var constants;
(function (constants) {
