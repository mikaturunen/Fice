...
var create = function (game) {
    ...
    player.sprite = game.add.sprite(game, // current game object
    game.width / 2, // X
    10, // Y
...
var preload = function () {
    return function () {
        return require("./preload")(phaserStorage.game);
    };
};
var create = function () {
    return function () {
        return require("./create")(phaserStorage.game);
    };
};
var update = function () {
    return function () {
        return require("./update")(phaserStorage.game);
    };
};
var render = function () {
    return function () {
        return require("./render")(phaserStorage.game);
    };
};
...
var game = {
     ...
     */
    start: function () {
        phaserStorage.game = new Phaser.Game(450, 700, Phaser.AUTO, "FIce", {
            preload: preload(),
            create: create(),
            update: update(),
            render: render()
...
},{"../utilities/phaser-storage":8}],6:[function(require,module,exports){
"use strict";
...
},{"../utilities/phaser-storage":8}],7:[function(require,module,exports){
"use strict";
