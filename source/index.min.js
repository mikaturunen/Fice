...
function resolveCollision(toResolve, toResolveCurrent, target) {
    if (toResolveCurrent.velocity.x <= -constant.VelocityTreshold && toResolveCurrent.tile.y === target.tile.y) {
        console.log("TTT ", toResolveCurrent, target);
        toResolve.x = target.coordinates.x + target.width;
        return true;
    }
    else if (toResolveCurrent.velocity.x >= constant.VelocityTreshold && toResolveCurrent.tile.y === target.tile.y) {
        toResolve.x = target.coordinates.x - target.width;
        return true;
    }
    else if (toResolveCurrent.velocity.y >= constant.VelocityTreshold && toResolveCurrent.tile.x === target.tile.x) {
