...
},{"../physics/physics":6,"../player/player":7,"../utilities/constants":8,"../utilities/utilities":9,"../world/tiles":10}],4:[function(require,module,exports){
"use strict";
var gameworld = require("./game/game");
gameworld.init();

},{"./game/game":3}],5:[function(require,module,exports){
"use strict";
var world = require("../world/tiles");
var utilities = require("../utilities/utilities");
var constant = require("../utilities/constants");
...
},{"../utilities/constants":8,"../utilities/utilities":9,"../world/tiles":10}],6:[function(require,module,exports){
var physics;
(function (physics) {
...
(function (player) {
    ...
    function checkInputs(game) {
        ...
        if (input.left.isDown) {
            ...
            player.sprite.body.next.x = player.sprite.body.x - (constant.TileSize.width / 2);
            ...
            player.sprite.body.velocity.y = 0;
            player.sprite.body.next.x = player.sprite.body.x + (constant.TileSize.width * 1.5);
            player.sprite.body.next.y = player.sprite.body.y;
        }
        console.log("sprite.body.velocity.x " + player.sprite.body.velocity.x);
    ...
    function update(game) {
        checkInputs(game);
        player.sprite.body.x += player.sprite.body.velocity.x;
        player.sprite.body.y += player.sprite.body.velocity.y;
    }
    player.update = update;
})(player || (player = {}));
module.exports = player;

},{"../physics/gravity":5,"../physics/physics":6,"../utilities/constants":8,"../utilities/utilities":9}],8:[function(require,module,exports){
"use strict";
var constants;
(function (constants) {
...
(function (utilities) {
    ...
    ;
    function getNextTileWorldCoordinates(velocityDirectionMultiplier, sprite, currentPosition, nextPosition, game) {
