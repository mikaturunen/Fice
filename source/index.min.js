...
},{"../physics/physics":5,"../player/player":6,"../utilities/constants":7,"../utilities/utilities":8,"../world/tiles":9}],4:[function(require,module,exports){
"use strict";
...
(function (player) {
    ...
    function checkInputs(game) {
        ...
        if (input.left.isDown) {
            ...
            player.sprite.body.next.x = utilities.floorToWorldTileCoordinate((player.sprite.body.x - (constant.TileSize.width / 2)));
    ...
    function update(game) {
        checkInputs(game);
        if (utilities.onNextPosition(player.sprite.body.velocity, player.sprite.body, player.sprite.body.next)) {
            player.sprite.body.velocity.x = player.sprite.body.velocity.y = 0;
            physics.isMovingBodies = false;
        }
...
},{"../physics/physics":5,"../utilities/constants":7,"../utilities/utilities":8}],7:[function(require,module,exports){
"use strict";
var constants;
(function (constants) {
...
(function (utilities) {
    ...
    function onNextPosition(velocity, currentPosition, nextPosition) {
        if (velocity.x > 0) {
...
},{"../../assets/levels/lvl.json":1,"./constants":7}],9:[function(require,module,exports){
"use strict";
var tiles;
(function (tiles) {
    tiles.map;
