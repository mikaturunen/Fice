...
},{"../utilities/utilities":11}],3:[function(require,module,exports){
...
},{"../utilities/utilities":11}],5:[function(require,module,exports){
"use strict";
...
},{"../blocks/blocks":2,"../fires/fire":4,"../physics/resolver":8,"../player/player":9,"../utilities/constants":10,"../utilities/utilities":11,"../world/tiles":12}],6:[function(require,module,exports){
"use strict";
var gameworld = require("./game/game");
gameworld.init();

},{"./game/game":5}],7:[function(require,module,exports){
"use strict";
var world = require("../world/tiles");
var utilities = require("../utilities/utilities");
var constant = require("../utilities/constants");
...
(function (resolver) {
    ...
    resolver.playerToBlockCollision = playerToBlockCollision;
    ;
    function playerToTargetCollision(player, target) {
        console.log("kill player", player, target);
    }
    resolver.playerToTargetCollision = playerToTargetCollision;
    ;
    function iceOverlapsFire(ice, fire) {
        console.log("Ice is overlapping fire.");
        ice.kill();
        fire.kill();
    }
    resolver.iceOverlapsFire = iceOverlapsFire;
    ;
...
},{"../blocks/blocks":2,"../fires/fire":4,"../player/player":9,"../world/tiles":12}],9:[function(require,module,exports){
"use strict";
var utilities = require("../utilities/utilities");
var constant = require("../utilities/constants");
