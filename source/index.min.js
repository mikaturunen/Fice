...
function isTileBlockingMovementVelocity() {
    return world.map.getTileWorldXY(physics.currentlyMovingBody.x + physics.currentlyMovingBody.velocity.x, physics.currentlyMovingBody.y + physics.currentlyMovingBody.velocity.y, constant.TileSize.width, constant.TileSize.heigth, "collision") ? true : false;
}
function isMoving() {
...
function move() {
    if (isTileBlockingMovement(physics.currentlyMovingBody.next.x, physics.currentlyMovingBody.next.y)) {
        ...
        var blockingTile;
        if (physics.currentlyMovingBody.velocity.y >= constant.VelocityTreshold && (blockingTile = getBlockingTile())) {
...
function checkCollision(target) {
    ...
    var currentX = Math.round(physics.currentlyMovingBody.x / constant.TileSize.width);
    var currentY = Math.round(physics.currentlyMovingBody.y / constant.TileSize.heigth);
...
function anotherBodyUnder(body) {
...
(function (physics) {
    ...
    function update(game) {
        ...
        if (!isMoving()) {
            var x = physics.currentlyMovingBody.x + (constant.TileSize.width / 2);
            var y = physics.currentlyMovingBody.y + (constant.TileSize.heigth * 1.5);
            var tile = world.map.getTileWorldXY(x, y, constant.TileSize.width, constant.TileSize.heigth, "collision");
