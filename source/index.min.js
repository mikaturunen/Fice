...
function checkCollision(current, target) {
    ...
    var currentX = Math.floor(current.x / constant.TileSize.width);
    var currentY = Math.floor(current.y / constant.TileSize.heigth);
    var currentLeft = currentX;
    var currentRight = currentX + 1;
    var currentTop = currentY - 1;
    var currentBottom = currentY + 1;
    var targetX = Math.floor(target.x / constant.TileSize.width);
    var targetY = Math.floor(target.y / constant.TileSize.heigth);
