...
;
function noTileDirectlyUnder(target) {
...
function noBodyDirectlyUnder(target) {
    var body = buildCollisionBody(target);
    var noBodyUnder = true;
    body.tile.y += 1;
    physics.physicsBodies.forEach(function (target) {
    ...
    function update(game) {
        ...
        physics.physicsBodies.forEach(function (targetBody) {
            ...
            if (checkCollision(targetBody)) {
                console.log("Collision between bodies:", physics.currentlyMovingBody.tiledType, physics.currentlyMovingBody._uniqueId, targetBody._uniqueId, targetBody.velocity.x);
