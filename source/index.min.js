...
function findFirstTileUnderBody() {
    var x = Math.floor((physics.currentlyMovingBody.x + constant.TileSize.width * 0.5) / constant.TileSize.width);
    var y = Math.floor(physics.currentlyMovingBody.y / constant.TileSize.heigth);
